  ...
  return (
    <HeroHighlight>
      ...
      <motion.h1
        ...
        className="mt-25 text-2xl px-4 md:text-2xl lg:text-3xl font-bold text-neutral-700 dark:text-white max-w-7xl leading-relaxed lg:leading-snug text-center mx-auto "
      >
        I specialize in{" "}
        <Highlight className="text-black dark:text-white">
          React, Node.js, Next.js, Mendix, and MongoDB
        </Highlight>{" "}
