...
function IntroSection() {
  return (
    <div className="h-auto md:h-[42rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md: py-0">
      <Spotlight className="-top-40 left-0 md:-top-20 md:left-60" fill="blue" />
      <div className="p-4 relative mt-10 z-10 w-full text-center">
        <h1 className="mt-20 md:pb-2  md:mt-5 text-2xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
          Crafting Scalable Solutions & Elegant Interfaces
        </h1>
        <p className="mt-5 font-normal text-center text-base md:text-lg text-neutral-300 max-w-2xl mx-auto">
